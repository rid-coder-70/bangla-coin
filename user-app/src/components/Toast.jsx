...
const AnimatedCheck = () => (
  <svg className="w-5 h-5 opacity-95" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3.5" strokeLinecap="round" strokeLinejoin="round">
    <motion.path
      ...
      {message && (
        ...
        >
          <div className={`flex items-center gap-3 px-5 py-3.5 rounded-2xl shadow-2xl backdrop-blur-md border border-white/20 text-sm font-bold tracking-wide
            ...
            {isSuccess ? <AnimatedCheck /> : <ShieldAlert className="w-5 h-5 opacity-90" />}
